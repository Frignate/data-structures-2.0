...
public class guitestClass extends JFrame  {
	...
	public guitestClass(ArrayList<Character> side1, ArrayList<Character> side2, battleObjectGui manager) {
		...
		Image pokemonBallPNG = new ImageIcon(this.getClass().getResource("/images/ball.png")).getImage();
	...
	public void setupBattleScreen(ArrayList<Character> side1, ArrayList<Character> side2)
	{
		...
		battlebuttons = new CustomButton[5];
		 ...
		 for (CustomButton customButton : battlebuttons) {
			...
			Image arena = new ImageIcon(this.getClass().getResource("/images/arena2.png")).getImage();
	...
	public class ScreenHandlernew implements ActionListener{
		...
		public void actionPerformed(ActionEvent event) {
			...
			Character bossChar = new Character("Plum, God of Donuts",40, boss,new ImageIcon (Toolkit.getDefaultToolkit().getImage(guitestClass.class.getResource("/images/monster.png"))),new ImageIcon (Toolkit.getDefaultToolkit().getImage(guitestClass.class.getResource("/images/impdead.png"))));
			bossChar.setupMoves(enemyActions);

			Character  lSoul1 = new Character("Lost Soul",20, lSoul,new ImageIcon (Toolkit.getDefaultToolkit().getImage(guitestClass.class.getResource("/images/lostsoul.png"))),new ImageIcon (Toolkit.getDefaultToolkit().getImage(guitestClass.class.getResource("/images/lostsoulDead.png"))));
			lSoul1.setupMoves(soulactions);
			
			Character  lSoul2 = new Character("Lost Soul",20, lSoul,new ImageIcon (Toolkit.getDefaultToolkit().getImage(guitestClass.class.getResource("/images/lostsoul.png"))),new ImageIcon (Toolkit.getDefaultToolkit().getImage(guitestClass.class.getResource("/images/lostsoulDead.png"))));
